...
- Struktur Folder  : 
    ...
    - Database berisi file Structured Query Language (SQL) yang mencakup skrip untuk membuat skema database
    - Perancangan adalah folder yang menyimpan artefak perancangan sistem seperti diagram UML, wireframe, atau dokumen spesifikasi kebutuhan
...
```
cd existing_repo
git remote add origin https://git.stis.ac.id/adienilma/sistem-desa-prima.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.stis.ac.id/adienilma/sistem-desa-prima/-/settings/integrations)
